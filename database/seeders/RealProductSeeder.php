...
class RealProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            ['Chicken Breast 1 KG', 'Daging Ayam', 42166.67, 51167, 'PCS', '621110600010', 0],
            ['Chicken Breast OD 1 KG', 'Daging Ayam', 40916.67, 49917, 'PCS', '621110600011', 0],
            ...
            ['Anggur Black Seedless', 'Buah', 42500, 60000, 'Pack', '621110700001', 10],
