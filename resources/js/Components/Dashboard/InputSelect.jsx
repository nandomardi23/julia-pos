        ...
        <div className='flex flex-col gap-2'>
            ...
            <Listbox value={selected} onChange={setSelected} multiple={multiple} by="id">
                <div className="relative">
                    ...
                    <Listbox.Options className={'absolute z-50 w-full mt-1 p-4 border rounded-lg flex flex-col gap-2 bg-gray-100 dark:border-gray-900 dark:bg-gray-950 max-h-60 overflow-auto shadow-lg'}>
                        {searchable && (
                            <input
                                type="text"
                                value={search}
