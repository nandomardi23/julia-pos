...
export default function Edit({ expense, categories }) {
    const [previewImage, setPreviewImage] = useState(
        expense.proof_image ? `/storage/expenses/${expense.proof_image}` : null
    )
    ...
    return (
        <>
            ...
            <div className="mb-6 flex justify-between items-center">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Edit Pengeluaran</h1>
                <Button
                    type={'link'}
                    label={'Kembali'}
                                ...
                                <label className="flex-1 cursor-pointer">
                                    <div className="border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg p-4 text-center hover:border-blue-500 transition-colors">
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-400">
                                            {data.proof_image ? data.proof_image.name : 'Klik untuk ganti'}
                                        </p>
                                    </div>
                                    <input
                                        type="file"
